...
quid.component.fakeSelect = function()
{
    ...
    var htmlFromSelect = function() {
        ...
        var value = $(this).triggerHandler('input:getValue');
        ...
        options.each(function(index, el) {
            var val = quid.base.str.cast($(this).prop('value'));
            var text = $(this).text() || "&nbsp;";
            var datas = $(this).getDataAttributes();
    ...
    var bindFakeSelect = function() {
        ...
        var bindChoices = function() {
            ...
            quid.main.keyboard.enter.call(choices,true);
        ...
        var choose = function(selected)
        {
            ...
            if(quid.base.str.cast(value) !== quid.base.str.cast(current))
            {
