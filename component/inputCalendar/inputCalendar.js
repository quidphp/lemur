...
{
    // clickOpen
    quid.core.clickOpenWithTrigger.call(this,"input[type='text']",'click',null,true);
    ...
    var bindInput = function() {
        ...
        quid.main.event.timeout.call(input,'keyup',600);
        quid.main.keyboard.enter.call(input,true);
