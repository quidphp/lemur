...
quid.main.attr = new function() {
    ...
    this.str = function(obj) {
        ...
        $.each(obj,function(key,value) {
            ...
            {
                value = quid.base.str.cast(value);
    ...
    this.addId = $.fn.addId = function(base)
    {
        $(this).not("[id]").each(function(index, el) {
            var newId = base+quid.uniqueInt();
    ...
    this.refreshId = $.fn.refreshId = function()
    {
        $(this).find("[id]").each(function(index, el) {
            var id = $(this).prop('id');
            var labels = $(this).labels();
            var newId = id+quid.uniqueInt();
            $(this).prop('id',newId);
            labels.prop('for',newId);
        });
    ...
    this.dataHrefReplaceChar = $.fn.dataHrefReplaceChar = function(replace,replace2) 
    {
        ...
        replace = quid.base.str.cast(replace);
        
        if(quid.base.number.is(replace2))
        replace2 = quid.base.str.cast(replace2);
