...
quid.main.triggerHandlerTrue = $.fn.triggerHandlerTrue = function(type)
{
    var r = false;
...
quid.main.triggerHandlerFalse = $.fn.triggerHandlerFalse = function(type)
{
    var r = false;
...
quid.main.block = $.fn.block = function(type) 
{
    if(quid.base.isStringNotEmpty(type))
    {
...
quid.main.timeout = $.fn.timeout = function(type,timeout)
{
    if(quid.base.isStringNotEmpty(type))
    {
        $(this).each(function(index) 
