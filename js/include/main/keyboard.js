...
// associé à l'élément
quid.main.enterBlock = $.fn.enterBlock = function(type)
{
...
quid.main.arrowCatch = $.fn.arrowCatch = function(preventDefault) 
{
    $(this).each(function()
    {
        var $this = $(this);
...
quid.main.escapeCatch = $.fn.escapeCatch = function()
{
    $(this).each(function()
    {
        var $this = $(this);
