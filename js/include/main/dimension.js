...
quid.main.heightWithPadding = $.fn.heightWithPadding = function()
{
...
quid.main.offsetCorner = $.fn.offsetCorner = function()
{
    var r = $(this).offset();
...
quid.main.anchorCorner = $.fn.anchorCorner = function(type)
{
    type = type || 'mouseover';
