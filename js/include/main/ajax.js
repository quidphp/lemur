...
quid.main.parseError = function(xhr,textStatus)
{
    ...
    if(quid.base.isStringNotEmpty(xhr.responseText))
    {
        r = xhr.responseText;
        var html;
        var parse = quid.main.parseHtmlDocument(xhr.responseText);
...
quid.main.ajax = $.fn.ajax = function(type) 
{
...
quid.main.ajaxEvents = $.fn.ajaxEvents = function()
{
    ...
    .on('ajax:trigger', function(event,config,tag,triggerEvent) {
        ...
        var r = quid.main.ajaxTrigger.call(this,config,tag);
...
quid.main.ajaxTrigger = $.fn.ajaxTrigger = function(config,tag)
{
    var r = null;
    var $this = $(this);
    ...
    if(tag === true)
    quid.main.ajaxConfigFromTag.call(this,config);
...
quid.main.ajaxConfigFromTag = $.fn.ajaxConfigFromTag = function(r)
{
...
quid.main.ajaxBlock = $.fn.ajaxBlock = function(type)
{
    if(quid.base.isStringNotEmpty(type))
    {
