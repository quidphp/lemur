...
quid.main.drag = new function() {
    ...
    this.scroll = $.fn.dragScroll = function(selector,targetTag,dividor)
    {
    ...
    // nécessite jqueryUi
    this.verticalSorting = $.fn.verticalSorting = function(items,handle,containment)
    {
