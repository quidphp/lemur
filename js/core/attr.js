...
quid.core.getAttributes = $.fn.getAttributes = function(start)
{
    var r = {};
...
quid.core.getDataAttributes = $.fn.getDataAttributes = function()
{
...
quid.core.replaceAttributes = $.fn.replaceAttributes = function(value,remove)
{
    if(remove === true)
...
quid.core.removeAttributes = $.fn.removeAttributes = function()
{
    $(this).each(function(index, el) {
        var $this = $(this);
        var node = $(this)[0];
...
quid.core.addIds = $.fn.addIds = function(base)
{
...
quid.core.refreshIds = $.fn.refreshIds = function()
{
...
quid.core.removeClassStart = $.fn.removeClassStart = function(prefix)
{
...
quid.core.hoverClass = $.fn.hoverClass = function(className)
{
...
quid.core.aExternalBlank = $.fn.aExternalBlank = function()
{
...
quid.core.addClassToLink = $.fn.addClassToLink = function(uris,classname)
{
...
quid.core.dataHrefReplaceChar = $.fn.dataHrefReplaceChar = function(replace,replace2) 
{
    var r = null;
...
quid.core.hrefChangeHash = $.fn.hrefChangeHash = function(fragment)
{
