...
quid.core.valSet = $.fn.valSet = function(separator,trim) 
{
    var r = '';
...
quid.core.inputGroup = $.fn.inputGroup = function()
{
    var $this = $();
...
quid.core.focusFirst = $.fn.focusFirst = function()
{
...
quid.core.labels = $.fn.labels = function()
{
    var r = $();
    var id = $(this).prop('id');
...
quid.core.focusSlide = $.fn.focusSlide = function(target) 
{
...
quid.core.inputValue = $.fn.inputValue = function(trim)
{
    var r = null;
