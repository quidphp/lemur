...
quid.core.parseHtmlDocument = function(html)
{
    var r = String(html);
...
quid.core.parseDocument = function(html)
{
    var r = {
        doc: quid.core.parseHtmlDocument(html),
        html: null,
        head: null,
        title: '?',
        meta: null,
...
quid.core.tagName = $.fn.tagName = function() 
{
    var r = null;
...
quid.core.outerHtml = $.fn.outerHtml = function(htmlOrText)
{
    var r = '';
...
quid.core.clickRemove = $.fn.clickRemove = function()
{
...
quid.core.wrapConsecutiveSiblings = $.fn.wrapConsecutiveSiblings = function(until,html)
{
...
quid.core.outsideClick = $.fn.outsideClick = function(value,parent) 
{
