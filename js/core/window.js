...
quid.core.smallWindow = $.fn.smallWindow = function()
{
...
quid.core.alert = $.fn.alert = function(type)
{
...
quid.core.confirm = $.fn.confirm = function(type) 
{
    if(quid.base.isStringNotEmpty(type))
    {
        $(this).on(type, function(event) {
...
quid.core.fragment = $.fn.fragment = function() 
{
